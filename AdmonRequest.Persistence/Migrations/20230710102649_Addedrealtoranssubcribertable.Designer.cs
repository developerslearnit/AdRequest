...
namespace AdmonRequest.Persistence.Migrations
{
    ...
    [Migration("20230710102649_Addedrealtoranssubcribertable")]
    partial class Addedrealtoranssubcribertable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AdmonRequest.Domain.Entities.PersonAdditionalInfo", b =>
                {
                    b.Property<Guid>("PersonAdditionalInfoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValueSql("newid()");
                    ...
                    b.Property<int>("PersonAdditionalInfoType")
                        .HasColumnType("int");
                    ...
                    b.HasKey("PersonAdditionalInfoId");

                    b.HasIndex("PersonRegistrationId");

                    b.ToTable("PersonAdditionalInfo", (string)null);
                });

            modelBuilder.Entity("AdmonRequest.Domain.Entities.PersonRegistration", b =>
                {
                    b.Property<Guid>("PersonRegistrationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<string>("PersonRegistrationNo")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
                    ...
                    b.Property<int>("PreferCommunication")
                        .HasColumnType("int");
                    ...
                    b.HasKey("PersonRegistrationId");

                    b.HasIndex("SNo");

                    b.ToTable("PersonRegistration", (string)null);
                });
            ...
            modelBuilder.Entity("AdmonRequest.Domain.Entities.PersonAdditionalInfo", b =>
                {
                    b.HasOne("AdmonRequest.Domain.Entities.PersonRegistration", "PersonRegistration")
                        .WithMany()
